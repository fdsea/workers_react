...
class AddWorker extends React.Component{
	...
	setDepartment(event){
		...
		value === 'office' ? this.setState({position: [{value: 'boss', data: 'Начальник'}, {value:'Manager', data: 'Менеджер'}]}) 
		 : value==='store' ? this.setState({position: [{value:'boss_of_store', data: 'Кладовщик'}, {value:"nearly_boss_of_store", data:'Приемщик'}]}) 
